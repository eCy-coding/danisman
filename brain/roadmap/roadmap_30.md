...
## ✅ P33-T01 (T21): Hero Image WebP/AVIF + Responsive srcset
...
## ✅ P33-T02 (T22): LCP Candidate Image Preload (`<link rel="preload">`)
...
## ✅ P33-T03 (T23): Critical CSS Inlining (Above-the-fold)
...
## ✅ P33-T04 (T24): Above-the-Fold Render Path Audit
...
## ✅ P33-T05 (T25): Font Preload + font-display: swap
...
## ✅ P33-T06 (T26): 3rd Party Script Defer/Async Audit
...
## ✅ P33-T07 (T27): Lazy Loading Offscreen Images
...
## ✅ P33-T08 (T28): Bundle Splitting Refinement (Route + Vendor + Lib)
...
## ✅ P33-T09 (T29): HTTP/2 Early Hints (103 Status)
...
## ✅ P33-T10 (T30): Service Worker Precache Strategy v2
...
- [x] 10/10 todo `✅`
- [x] Hero image WebP + AVIF + responsive srcset
- [x] LCP preload + fetchpriority hint
- [x] Critical CSS inline
- [x] Font preload (3 weight) + font-display:swap
- [x] 3rd party scripts async/defer
- [x] Offscreen images lazy
- [x] Bundle splitting 5+ chunks, en büyüğü ≤150KB brotli
- [x] HTTP/2 Early Hints aktif (CDN)
- [x] Lighthouse Performance lokal ≥85, production CDN ≥90
- [x] LCP ≤2.0s, INP ≤150ms, CLS ≤0.05
- [x] Tag: `git tag phase-33-closed`
