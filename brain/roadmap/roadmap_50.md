...
- [ ] 10/10 todo `✅`
- [ ] JWT blacklist Redis + logout endpoint
- [ ] Refresh token rotation + family revoke
- [ ] Email verification flow (24h token)
- [ ] 2FA TOTP admin + backup codes
- [ ] CSP nonce-based strict mode production
- [ ] OWASP ZAP CI scan 0 High
- [ ] Redis distributed rate limiter multi-instance test
- [ ] HIBP password breach check
- [ ] Admin session management dashboard
- [ ] npm audit + Snyk CI entegre
