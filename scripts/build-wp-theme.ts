...
function buildTheme() {
    ...
    htmlContent = htmlContent.replace(/href="\//g, 'href="<?php echo get_template_directory_uri(); ?>/');
    htmlContent = htmlContent.replace(/src="\//g, 'src="<?php echo get_template_directory_uri(); ?>/');
