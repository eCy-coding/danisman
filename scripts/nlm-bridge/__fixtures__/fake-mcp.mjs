...
const STUDIO_REPORT_TEXT = [
  ...
  '## Sayısal Görünüm',
  '',
  'TÜİK verilerine göre dijitalleşen aile şirketlerinde verimlilik 2024 yılında %23,5 artmıştır. Yapay zekâ yatırımı yapan KOBİ sayısı son üç yılda 48 binden 112 bine çıkmıştır. Halefiyet planı olan şirketlerin oranı ise yalnızca %18 düzeyindedir.',
  '',
