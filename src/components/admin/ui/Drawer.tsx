...
export const Drawer: React.FC<DrawerProps> = ({
  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby={title ? 'drawer-title' : undefined} className="fixed inset-0 z-50">
      ...
      >
        ...
        {footer && (
          <footer className="px-6 py-4 border-t border-white/5 flex justify-end gap-2">{footer}</footer>
        )}
      </aside>
    </div>
  );
