  ...
  const getLevel = (s: number) => {
    if (s < 40)
      return {
        label: 'Başlangıç',
        color: 'text-red-400',
        desc: 'Dijital dönüşüm yolculuğunun başındasınız.',
      };
    if (s < 70)
      return {
        label: 'Gelişmekte',
        color: 'text-yellow-400',
        desc: 'Temel adımları attınız, optimizasyona ihtiyacınız var.',
      };
    return {
      label: 'Lider',
      color: 'text-green-400',
      desc: 'Sektör standartlarının üzerinde bir vizyona sahipsiniz.',
    };
  };
