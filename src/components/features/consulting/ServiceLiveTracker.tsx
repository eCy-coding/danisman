...
export const ServiceLiveTracker: React.FC<ServiceLiveTrackerProps> = ({ serviceId }) => {
  ...
  return (
    <div data-testid="live-tracker" className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/5 border border-white/10 rounded-full backdrop-blur-sm animate-fade-in">
