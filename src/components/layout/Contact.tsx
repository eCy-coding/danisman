...
const createContactSchema = (lang: 'tr' | 'en') => {
  return z.object({
    name: z.string().min(2, {
      message: lang === 'tr' ? 'Adınız en az 2 karakter olmalıdır.' : 'Name must be at least 2 characters.',
    }),
    email: z.string().email({
      message: lang === 'tr' ? 'Geçerli bir e-posta adresi giriniz.' : 'Please enter a valid email address.',
    }),
    subject: z.string().min(3, {
      message: lang === 'tr' ? 'Konu en az 3 karakter olmalıdır.' : 'Subject must be at least 3 characters.',
    }),
    message: z.string().min(10, {
      message: lang === 'tr' ? 'Mesajınız en az 10 karakter olmalıdır.' : 'Message must be at least 10 characters.',
    }),
...
export const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-24 lg:py-32 bg-neutral border-t border-white/5" aria-labelledby="contact-heading">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              <h2 id="contact-heading" className="text-h2-d font-sans font-medium text-white mb-8 tracking-tight">
              ...
              <div className="space-y-10 border-t border-white/10 pt-10">
                <div>
                  ...
                  <p className="text-white text-xl font-sans">{CONTACT_CONFIG.address[lang as keyof typeof CONTACT_CONFIG.address]}</p>
                </div>
                ...
                <>
                  ...
                  <form className="space-y-6" onSubmit={handleSubmit(async (data) => {
                   ...
                   {status === 'error' && serverError && (
                    <div className="bg-red-900/30 border border-red-700/30 text-red-300 px-4 py-3 rounded-lg flex items-center gap-2" role="alert">
                      <AlertCircle size={18} />
