...
const KPI_COPY = {
  ...
  description: { tr: 'Yılların getirdiği tecrübe ve uzmanlıkla elde ettiğimiz somut sonuçlar.', en: 'Concrete results achieved through years of experience and expertise.' }
};

const KPIItem: React.FC<{ item: (typeof KPI_ITEMS)[0]; delay: number; lang: 'tr' | 'en'; span?: string }> = ({
  item,
  delay,
  lang,
  span = "col-span-1"
  ...
  return (
    ...
    >
      <MouseGlow />
      <div className={`absolute inset-0 bg-linear-to-br ${getGradient(item.category)} opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none`} />
      
      <div className="relative z-10 flex flex-col h-full justify-between">
        <div className="flex flex-col">
          <div className="text-white font-medium text-2xl mb-1 tracking-wide">{item.label[lang]}</div>
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col items-center text-center mb-20 lg:mb-32">
          <FadeIn>
            <h2 id="kpi-heading" className="text-h2-d font-sans font-light mb-6 leading-tight tracking-tight">
