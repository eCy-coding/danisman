...
export const Services: React.FC = () => {
  ...
  if (!displayServices || displayServices.length === 0) {
    return <div className="py-24 text-center">{t('noServices')}</div>;
  }

  return (
    <div id="services">
      <section className="py-24 lg:py-32 px-6 md:px-12 max-w-7xl mx-auto relative flex flex-col lg:flex-row gap-16 items-start">
        ...
        <div className="lg:sticky lg:top-32 lg:w-1/3 space-y-6">
          ...
          <FadeIn delay={100}>
            <h2 className="font-serif-display text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-[1.1]">
