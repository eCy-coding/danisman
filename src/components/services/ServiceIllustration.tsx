...
const ILLUSTRATIONS: ProfileMap = {
  ...
  'mergers-acquisitions': (
    <svg {...SVG_PROPS}>
      ...
      <path
        d="M 70 75 Q 100 110 100 130"
        stroke="url(#s2-grad)"
        strokeWidth={STROKE}
        strokeLinecap="round"
      />
      <path
        d="M 130 75 Q 100 110 100 130"
        stroke="url(#s2-grad)"
        strokeWidth={STROKE}
        strokeLinecap="round"
      />
  ...
  'family-business': (
    <svg {...SVG_PROPS}>
      ...
      <path
        d="M 100 54 L 60 86 M 100 54 L 140 86 M 60 114 L 40 149 M 60 114 L 80 149 M 140 114 L 120 149 M 140 114 L 160 149"
        stroke="url(#s3-grad)"
  ...
  'operational-excellence': (
    <svg {...SVG_PROPS}>
      ...
      <path
        d="M 30 150 L 80 150 L 90 140 L 110 160 L 120 150 L 170 150"
        stroke="url(#s4-grad)"
        strokeWidth={STROKE * 1.4}
        strokeLinecap="round"
        fill="none"
  ...
  neuromarketing: (
    <svg {...SVG_PROPS}>
      <Defs id="s5" />
      <path
        d="M 60 60 Q 30 100 60 140 Q 100 160 100 100 Q 100 60 60 60 Z"
        stroke="url(#s5-grad)"
        strokeWidth={STROKE}
      />
      <path
        d="M 140 60 Q 170 100 140 140 Q 100 160 100 100 Q 100 60 140 60 Z"
        stroke="url(#s5-grad)"
        strokeWidth={STROKE}
      />
  ...
  'hr-transformation': (
    <svg {...SVG_PROPS}>
      ...
      <path
        d="M 100 74 L 50 118 M 100 74 L 100 118 M 100 74 L 150 118"
        stroke="url(#s6-grad)"
        strokeWidth={STROKE}
      />
    </svg>
  ...
  'crisis-management': (
    <svg {...SVG_PROPS}>
      ...
      />
      <path
        d="M 65 105 L 85 105 L 92 85 L 105 125 L 115 100 L 135 100"
        stroke="url(#s7-gold)"
  ...
  'data-governance': (
    <svg {...SVG_PROPS}>
      ...
      <path
        d="M 60 55 V 105 Q 60 117 100 117 Q 140 117 140 105 V 55"
        stroke="url(#s10-grad)"
        strokeWidth={STROKE}
        fill="none"
      />
      ...
      />
      <path
        d="M 90 130 V 122 Q 90 110 100 110 Q 110 110 110 122 V 130"
        stroke="url(#s10-grad)"
        strokeWidth={STROKE}
      />
  ...
  'esg-strategy': (
    <svg {...SVG_PROPS}>
      ...
      <path
        d="M 100 70 L 75 85 M 100 90 L 75 105 M 100 110 L 75 125 M 100 70 L 125 85 M 100 90 L 125 105 M 100 110 L 125 125"
        stroke="url(#s11-grad)"
        strokeWidth={STROKE * 0.7}
      />
  ...
  'investment-incentives': (
    <svg {...SVG_PROPS}>
      ...
      <path
        d="M 100 90 L 100 50 M 90 60 L 100 50 L 110 60"
        stroke="url(#s12-gold)"
        strokeWidth={STROKE * 1.6}
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  'industrial-relations': (
    <svg {...SVG_PROPS}>
      <Defs id="s15" />
      <path
        d="M 35 100 L 75 100 L 95 110 L 105 110 L 125 100 L 165 100"
        stroke="url(#s15-grad)"
      ...
      />
      <path
        d="M 75 100 L 75 130 L 95 130 L 95 110"
        stroke="url(#s15-grad)"
        strokeWidth={STROKE}
        fill="none"
      />
      <path
        d="M 125 100 L 125 130 L 105 130 L 105 110"
        stroke="url(#s15-grad)"
        strokeWidth={STROKE}
        fill="none"
      />
  ...
  'payroll-audit': (
    <svg {...SVG_PROPS}>
      <Defs id="s16" />
      <path
        d="M 65 30 L 135 30 L 135 175 L 120 165 L 105 175 L 90 165 L 75 175 L 65 165 Z"
        stroke="url(#s16-grad)"
        strokeWidth={STROKE}
        fill="none"
      />
  ...
  'employer-branding': (
    <svg {...SVG_PROPS}>
      <Defs id="s17" />
      <path
        d="M 100 30 L 145 55 L 145 105 Q 145 145 100 165 Q 55 145 55 105 L 55 55 Z"
        stroke="url(#s17-grad)"
        strokeWidth={STROKE * 1.4}
        fill="none"
      />
      <path
        d="M 100 65 L 109 86 L 132 88 L 114 102 L 120 124 L 100 112 L 80 124 L 86 102 L 68 88 L 91 86 Z"
        fill="url(#s17-gold)"
        stroke="url(#s17-grad)"
        strokeWidth={STROKE * 0.7}
      />
  ...
  'market-entry': (
    <svg {...SVG_PROPS}>
      ...
      <path
        d="M 45 80 Q 100 70 155 80"
        stroke="url(#s18-grad)"
        strokeWidth={STROKE * 0.7}
        fill="none"
      />
      <path
        d="M 45 120 Q 100 130 155 120"
        stroke="url(#s18-grad)"
        strokeWidth={STROKE * 0.7}
        fill="none"
      />
  ...
  'global-intelligence': (
    <svg {...SVG_PROPS}>
      ...
      <path
        d="M 100 100 L 100 40 A 60 60 0 0 1 140 70 Z"
        fill="url(#s19-grad)"
        opacity="0.15"
        stroke="url(#s19-grad)"
        strokeWidth={STROKE}
