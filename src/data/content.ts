...
export const TRUST_LOGOS: TrustLogo[] = [
  {
    id: 'tech-scaleup',
    name: 'Tech Scale-up',
    sector: { tr: 'Teknoloji', en: 'Tech Scale-up' },
    alt: { tr: 'Tech Scale-up Logo', en: 'Tech Scale-up Logo' },
    src: '/clients/tech-scaleup.svg',
  },
  {
    id: 'family-holding',
    name: 'Family Holding',
    sector: { tr: 'Aile Holdingi', en: 'Family Holding' },
    alt: { tr: 'Family Holding Logo', en: 'Family Holding Logo' },
    src: '/clients/family-holding.svg',
  },
  {
    id: 'manufacturing-group',
    name: 'Manufacturing Group',
    sector: { tr: 'Üretim Grubu', en: 'Manufacturing Group' },
    alt: { tr: 'Manufacturing Group Logo', en: 'Manufacturing Group Logo' },
    src: '/clients/manufacturing-group.svg',
  },
  {
    id: 'ma-advisory',
    name: 'M&A Advisory',
    sector: { tr: 'M&A Danışmanlık', en: 'M&A Advisory' },
    alt: { tr: 'M&A Advisory Logo', en: 'M&A Advisory Logo' },
    src: '/clients/ma-advisory.svg',
  },
  {
    id: 'cultural-org',
    name: 'Cultural Org',
    sector: { tr: 'Kültür Kurumu', en: 'Cultural Org' },
    alt: { tr: 'Cultural Org Logo', en: 'Cultural Org Logo' },
    src: '/clients/cultural-org.svg',
  },
  {
    id: 'fintech',
    name: 'FinTech',
    sector: { tr: 'FinTech', en: 'FinTech' },
    alt: { tr: 'FinTech Logo', en: 'FinTech Logo' },
    src: '/clients/fintech.svg',
  },
  {
    id: 'b2b-saas',
    name: 'B2B SaaS',
    sector: { tr: 'B2B SaaS', en: 'B2B SaaS' },
    alt: { tr: 'B2B SaaS Logo', en: 'B2B SaaS Logo' },
    src: '/clients/b2b-saas.svg',
  },
  {
    id: 'retail-chain',
    name: 'Retail Chain',
    sector: { tr: 'Perakende Zinciri', en: 'Retail Chain' },
    alt: { tr: 'Retail Chain Logo', en: 'Retail Chain Logo' },
    src: '/clients/retail-chain.svg',
  },
];
