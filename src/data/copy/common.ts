...
export const NAV_ITEMS = {
    ...
    insights: {
        ...
        children: [
            ...
            { id: 'case-studies', label: { tr: "Vaka Analizleri", en: "Case Studies" }, href: '/case-studies' }
        ]
    },
    pricing: {
        id: 'pricing',
...
export const MEGA_MENUS = {
    services: {
                ...
                items: [
                    {
                        ...
                        description: { tr: "Uzun vadeli rekabet avantajı ve büyüme yol haritası", en: "Long-term competitive advantage and growth roadmap" },
                    ...
                    },
                    {
                        ...
                        description: { tr: "Birleşme, satın alma ve entegrasyon süreçleri", en: "Mergers, acquisitions and integration processes" },
                        href: '/services/strategy',
                        iconName: 'Handshake'
                    },
                    {
                        ...
                        description: { tr: "Verimli yapılar ve yönetim modelleri", en: "Efficient structures and governance models" },
                        href: '/services/strategy',
                        iconName: 'Network'
                    }
                ]
                ...
                items: [
                    {
                        ...
                        description: { tr: "AI olgunluk değerlendirmesi ve uygulama yol haritası", en: "AI maturity assessment and implementation roadmap" },
                    ...
                    },
                    {
                        ...
                        description: { tr: "Uçtan uca dijitalleşme ve platform modernizasyonu", en: "End-to-end digitization and platform modernization" },
                        href: '/services/digital',
                        iconName: 'Zap'
                    },
                    {
                        ...
                        description: { tr: "Ölçeklenebilir bulut mimarisi ve geçiş stratejisi", en: "Scalable cloud architecture and migration strategy" },
                        href: '/services/digital',
                        iconName: 'Cloud'
                    }
                ]
                ...
                items: [
                    {
                        ...
                        description: { tr: "Pazar penetrasyonu ve yeni gelir akışları", en: "Market penetration and new revenue streams" },
                        href: '/services',
                        iconName: 'TrendingUp'
                    },
                    {
                        ...
                        description: { tr: "Operasyonel verimlilik ve maliyet optimizasyonu", en: "Operational efficiency and cost optimization" },
                        href: '/services',
                        iconName: 'BarChart3'
                    },
                    {
                        ...
                        description: { tr: "Otomasyon, süreç mükemmelliği ve lean yönetim", en: "Automation, process excellence and lean management" },
                        href: '/services',
                        iconName: 'Settings'
                    }
                ]
        ...
        featured: {
            ...
            description: { tr: "Organizasyonunuzun yapay zeka hazırlığını 15 dakikada ölçün. Kişiselleştirilmiş yol haritanızı alın.", en: "Measure your organization's AI readiness in 15 minutes. Get your personalized roadmap." },
    ...
    insights: {
                ...
                items: [
                    {
                        ...
                        description: { tr: "Dijital bankacılık ve regülasyon uyumu", en: "Digital banking and regulatory compliance" },
                        href: '/case-studies',
                        iconName: 'DollarSign'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        description: { tr: "Endüstri 4.0 ve akıllı fabrika dönüşümü", en: "Industry 4.0 and smart factory transformation" },
                        href: '/case-studies',
                        iconName: 'Factory'
                    }
                ]
                ...
                items: [
                    {
                        ...
                        description: { tr: "Uzman görüşleri ve sektör analizleri", en: "Expert opinions and industry analyses" },
                        href: '/blog',
                        iconName: 'BookOpen'
                    },
                    {
                        ...
                        description: { tr: "Gerçek dönüşüm hikayeleri ve ölçülebilir sonuçlar", en: "Real transformation stories and measurable results" },
                        href: '/case-studies',
                        iconName: 'FileText'
                    }
                ]
                ...
                items: [
                    {
                        ...
                        description: { tr: "Kanıtlanmış çerçevemiz ve uygulama prensiplerimiz", en: "Our proven framework and delivery principles" },
                        href: '/methodology',
                        iconName: 'Compass'
                    },
                    {
                        ...
                        description: { tr: "Vizyonumuz, ekibimiz ve değerlerimiz", en: "Our vision, team and values" },
                        href: '/about',
                        iconName: 'Building2'
                    }
                ]
        ...
        featured: {
            ...
            description: { tr: "Fortune 500 şirketlerinde AI benimseme trendleri ve başarı faktörleri.", en: "AI adoption trends and success factors across Fortune 500 companies." },
            href: '/blog',
