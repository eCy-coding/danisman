...
export const PILLARS_CONTENT: PillarContent[] = [
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    subtitle:
      'Türkiye iş ekonomisinin bel kemiği aile şirketleri için Aile Anayasası + Family Council mimarisi.',
    executiveSummary:
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'İki ayrı yapı. Family Council aile üyelerinin "owner" rolündeki forumu — strateji, vizyon, ailenin uzun vadeli refahı konuşulur. Yönetim Kurulu şirketin operasyonel karar mercii — ticari kararlar, yönetim atamaları, finansal performans burada görüşülür. Karışıklığa son: karar hakları matrisi (decision rights) bu iki organın sınırını netleştirir. Family Council ayda 1, Yönetim Kurulu ayda 1 + ad-hoc — ritim engagement\'ta kurulur.',
      },
      {
        heading: 'Succession Planlaması (3-7 Yıllık)',
        body: 'Yetki devir takvimi, kuşak transfer mentor programı, profesyonel CEO/CFO interview desteği. Acele değil, planlı geçiş. Kurucu hala aktif iken next-gen rotasyonu başlar. Mentor programı: kurucu × next-gen pair, haftalık 2 saatlik yapılandırılmış paylaşım. Profesyonel CEO/CFO atanırsa: interview panel + onboarding 90-günlük plan + reporting line netleştirme.',
      },
      {
        heading: 'Akraba İstihdam Politikası',
        body: "Aile şirketlerinde en yaygın çatışma kaynağı — akrabalar şirkette nasıl istihdam edilir? Yazılı politika engagement'ta tasarlanır: minimum dış deneyim (örn: 3 yıl), giriş düzeyi pozisyon yasağı, performans standartları aynı (favoritism yasak), yıllık değerlendirme aile dışı yönetici yapar. Bu kurallar Family Council'da onaylanır, exception'lar açık ve belgeli olur.",
      },
      {
        heading: 'Kar Payı Dağıtım Formülü',
        body: 'Yıllık 1 kez kriz yaratan kar payı tartışması yapılandırılmış formüle bağlanır. Tipik framework: %X yeniden yatırım (zorunlu), %Y aile vakfı (sosyal sorumluluk), %Z dağıtım. Dağıtım hisse oranı bazlı; performans bonusu sadece şirkette aktif çalışan aile üyeleri için, ayrı bir bütçeden.',
      },
      {
        heading: 'Aile Vakfı + Family Office (4. Nesil+)',
        body: '20+ hissedarlık olunca artık holding governance yetmez — aile vakfı + private family office mimarisi gerekir. Engagement bu yapıyı kurar: vakıf hukuki çerçeve, family office yönetim organizasyonu, portfolio investment policy, next-gen eğitim fonu, philanthropy stratejisi.',
      },
    ],
    ctaCopy:
      'Aile şirketinizin governance yolculuğu için Discovery Call planla — Aile Anayasası deneyimimizi konuşalım.',
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    subtitle:
      'OEE +%15, lead time -%50, FPY +%10 sektörel benchmark — sahaya inerek + sürdürülebilir disiplinle.',
    executiveSummary:
    ...
    sections: [
      {
        ...
        body: "Sahada bizzat akış izleme. Current state value stream haritası. 7 müda (israf) tanımlama: aşırı üretim, bekleme, transport, aşırı işleme, envanter, hareket, kusur. Future state target çiziminde sektörel benchmark kullanırız. Engagement'in ilk 2 haftasında sahada günde 4-6 saat, ekip içerisinde yer alarak detaylı gözlem yaparız.",
      },
      {
        heading: 'DMAIC Six Sigma Projeleri',
        body: 'Define-Measure-Analyze-Improve-Control. Her DMAIC proje 6-8 hafta. Define: problem statement, başarı kriteri. Measure: baseline ölçüm, MSA (measurement system analysis). Analyze: root cause analysis (5 Whys, fishbone, hypothesis testing). Improve: solution design, pilot. Control: SPC chart, lessons learned, handoff.',
      },
      {
        heading: "Kaizen Sprint'leri (6-8 hafta)",
        body: "Haftalık 2-3 günlük kaizen workshop'ları. SMED ile setup time azaltma (target: %50+ reduction), 5S ile alan organizasyonu, kanban ile pull production, poka-yoke ile hata önleme. Her kaizen pilot bir hat veya hücrede yapılır, başarı kanıtlanınca scale olur.",
      },
      {
        heading: 'Daily Management Board',
        body: "Sürdürülebilirlik için kritik. Her saha vardiyasında günlük 10-15 dakikalık standup. Board'da: dünün KPI sonucu (renk kodlu), bugünün hedefleri, eskalasyon edilen sorunlar, dünden gelen learn-out. Engagement sonrası ekip liderleri bunu kendi başına yönetir.",
      },
      {
        heading: 'Tedarik Zinciri Optimizasyonu',
        body: "Sadece üretim değil — uçtan uca lojistik. Stok devir hızı, safety stock seviyesi, supplier OTIF (on-time-in-full), lead time variability. ABC analizi → C-class SKU'lar konsolidasyon, A-class'da JIT discipline. Hedef: %20-40 stok devir hızı artışı.",
      },
      {
        heading: 'Six Sigma Green Belt Eğitim',
        body: "Engagement'in parçası olarak ekibinize 3 modül Green Belt eğitim. Modül 1: DMAIC fundamentals + statistics basics. Modül 2: tools (Minitab/Excel statistical analysis). Modül 3: project execution. Sertifikalandırma: engagement içinde tamamladıkları kendi proje + tez ile.",
      },
    ],
    ...
    sections: [
      {
        ...
        body: 'Strateji, süreç, teknoloji, veri, kültür, organizasyon. Sektörel benchmark. 3-yıllık teknoloji vizyonu; build-buy-partner kararları. Olgunluk skoru 0-100; engagement öncesi baseline + 12 ay sonra re-audit ile delta ölçüm.',
      },
      {
        heading: 'AI Use-Case Portfolio',
        body: 'Impact × feasibility matrisi. 5-10 use-case listesi. Top 2-3 pilot ML/GenAI projesi production-ready. Use case kategorileri: tahmin (demand forecasting, churn), classification (lead scoring, document tagging), GenAI (knowledge management, customer support), optimization (route, pricing).',
      },
      {
        heading: 'MLOps Pipeline + Model Governance',
        body: 'Pilot başarısı production-ready demek değildir. MLOps pipeline kurulumu: model versioning (DVC, MLflow), CI/CD for models, monitoring (drift detection, latency), retraining schedule, A/B testing framework, rollback procedures. Model governance: KVKK uyum, bias audit, explainability requirements.',
      },
      {
        heading: 'ERP + CRM Seçim Süreci',
        body: "Vendor-agnostic. SAP, Oracle NetSuite, Microsoft Dynamics, lokal alternatives — fit-gap analizi engagement'ta yapılır. RFP, demo, reference call, contract negotiation desteği. Implementation partner seçimi: scope-fit + Türkiye experience + post-go-live support critical.",
      },
      {
        heading: 'RPA + Süreç Otomasyon',
        body: "Pilotlar 6 ay sonra unutuluyor — sebep yapı eksikliği. CoE (Center of Excellence) modeli engagement'ta kurulur. UiPath/Power Automate/Automation Anywhere vendor seçimi + 5-10 use case pilot (high-volume rule-based: invoice processing, data entry, report generation) + governance + ROI tracking.",
      },
      {
        heading: 'IT Operating Model',
        body: "Centralized vs federated vs hybrid. CTO/CDO C-level decision table'da. Change management plan + capability building. Engagement sonu: yazılı IT operating model dokümanı + 3-yıllık talent roadmap + technology investment portfolio matrix.",
      },
    ],
    ctaCopy:
      'AI/dijital dönüşüm yolculuğunuzda doğru sıralamayı birlikte belirleyelim — Discovery Call.',
  ...
  // ──────────────────────────────────────────────────────────────
  {
    ...
    subtitle:
      'AB Yeşil Mutabakatı 2026 takvimine sektörünüzü hazırlıyoruz — maliyet değil rekabet avantajı.',
    executiveSummary:
    ...
    sections: [
      {
        ...
        body: 'Hangi ESG konuları sektör + paydaş için kritik. Stakeholder interview (10-20 anket + 5-8 derinleşmeli görüşme) → öncelik haritası. GRI / SASB / TCFD / CSRD framework seçimi sektörlere göre. Engagement çıktısı: materiality matrix + raporlama scope tanımı.',
      },
      {
        heading: 'Karbon Envanteri (Scope 1+2+3)',
        body: "ISO 14064 / GHG Protocol uyumlu. Scope 1: direkt emisyon (yakıt, üretim süreç). Scope 2: indirek (elektrik, ısı). Scope 3: tedarik zinciri + ürün kullanımı + atık (en zor). Scope 3 tedarikçi data toplama 6-12 ay süreç; engagement'ta primary data collection survey + benchmark estimation hybrid.",
      },
      {
        heading: 'CBAM Etki Simülasyonu',
        body: "AB'ye ihracatınız varsa karbon-yoğun ürünlerde (demir-çelik, çimento, alüminyum, gübre, hidrojen, elektrik) 2026 itibariyle ek vergi. Etki simülasyonu engagement ilk fazında yapılır: mevcut ihracat × CBAM tariff × karbon yoğunluğu = ek maliyet. Senaryo analizi: status quo vs decarbonization invest. Ortalama ROI: 2-4 yıl.",
      },
      {
        heading: 'Decarbonization Roadmap',
        body: '5-10 yıllık plan. Quick wins (yıl 1-2): enerji verimliliği, lighting LED, renewable PPA. Medium-term (yıl 3-5): proses elektrifikasyonu, hidrojen pilotu, supplier engagement. Long-term (yıl 6-10): değer zinciri transformasyonu, circular economy initiatives, net-zero hedefi.',
      },
      {
        heading: 'CSRD Reporting Compliance',
        body: "Corporate Sustainability Reporting Directive 2024'ten itibaren EU-listed firmalar için zorunlu, 2026'dan itibaren büyük private şirketler dahil. ESRS (European Sustainability Reporting Standards) 12 standart üzerinden raporlama. Engagement'ta CSRD readiness assessment + gap analizi + reporting framework kurulumu.",
      },
      {
        heading: 'Yeşil Finansman Erişimi',
        body: "Sustainable bond, green loan, EU Horizon hibe, TÜBİTAK ESG fonları. Engagement'ta finansman pitch hazırlığı + ESG due diligence preparation + reporting commitment templates. Tipik %1-2 düşük faizle borçlanma fırsatı; ROI engagement maliyetini 1-2 yılda karşılar.",
      },
    ],
    ctaCopy:
      'CBAM ve CSRD hazırlığınızı birlikte planlayalım — Discovery Call ile ESG yolculuğunuza başlayın.',
