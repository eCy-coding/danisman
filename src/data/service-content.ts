...
const SHARED_FAQ_END = (slug: string) => [
  {
...
const SERVICE_CONTENT_LIST: ServiceContent[] = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Discovery & Diagnostic', duration: '1 hafta', description: 'Üst yönetim ile bire bir görüşmeler (30-60 dk), mevcut strateji dokümanlarının review\'ı, son 3 yılın finansal ve operasyonel KPI baseline\'ı.' },
        { name: '2. Vision Architecture Workshop', duration: '2 hafta', description: 'C-level ile 2x yarım gün workshop: "nerede oynuyoruz", "nasıl kazanacağız", "hangi varsayımlar kritik". Çıktı: 3-5 yıllık kuzey yıldızı dokümanı.' },
        { name: '3. Strategy Bridge', duration: '3 hafta', description: 'Vizyon → OKR → 90 günlük yol haritasına dönüşüm. RACI matrisi, decision rights, haftalık ritim takvimi.' },
        { name: '4. Pilot & Calibration', duration: '4 hafta', description: 'İlk 30 günde uygulama; haftalık check-in; metrik baseline ölçümü; varsayım test edilir, gerekirse stratejik revize.' },
        { name: '5. Handoff & Retrospective', duration: '2 hafta', description: 'Yönetim ekibine self-sustain handoff. Engagement-sonu retrospektif raporu. 6 ay sonra opsiyonel anonim takip.' },
      ],
    },
    deliverables: {
    ...
    faq: {
      items: [
        { q: 'Strateji dokümanım zaten var. Bu engagement\'ı yine ihtiyacım var mı?', a: 'Doküman varsa Discovery fazında onu temel alırız. Ekleme değer: ekibin günlük operasyonuyla strateji arasındaki kopukluğu kapatmak (OKR + ritim + RACI). Sadece doküman güncellemiyoruz, uygulama köprüsü kuruyoruz.' },
        { q: 'Üst yönetim çok meşgul, 12 hafta boyunca ne kadar zaman ayırması gerekir?', a: 'C-level toplam ~30 saat (4 yarım gün workshop + 90 dk haftalık check-in + retrospective). Diğer süre danışman ekibinin background work\'ü ile geçer.' },
        { q: 'Engagement bittikten sonra strateji kalıcı olur mu yoksa eski hale mi döner?', a: 'Handoff fazında ekibe haftalık ritim disiplinini kuruyoruz; OKR cadence kendi başına işliyor. 6 ay sonra anonim retrospektif ile öğrenmeleri konsolide ederiz. Süreklilik için "Yıllık Ortaklık" modeli de mevcut.' },
        { q: 'Aile şirketiyiz, kuşaklar arası vizyon farkı var. Bu engagement bunu da çözer mi?', a: 'Evet. Discovery fazında nesil bazlı vizyon görüşmeleri yaparız; Vision Architecture workshop\'unda farklılıkları masaya koyar, ortak bir kuzey yıldızı üretmek için yapılandırılmış müzakere kullanırız. Aile şirketleri yönetişimi ile birlikte planlanabilir.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Şirket değerleme, due diligence, birleşme sonrası entegrasyon (PMI) ve exit stratejileri.',
      valueProp: 'M&A süreçlerinde stratejik uyumdan kapanışa ve entegrasyona kadar üst yönetime objektif danışmanlık. Değerleme tartışmalarını sayısal ve sektörel anchor ile masaya koyar.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Strategic Fit Diagnostic', duration: '1-2 hafta', description: 'Stratejik uyum analizi: target neden, beklenen sinerji, risk haritası. Go/no-go önerisi.' },
        { name: '2. Valuation & Modeling', duration: '2-3 hafta', description: 'DCF + comparable + asset-based üç metot. Sektörel multiple benchmark. Senaryo analizi (base / bull / bear).' },
        { name: '3. Due Diligence Yönetimi', duration: '4-6 hafta', description: 'Mali, hukuki, operasyonel, kültürel DD. Hukuk firması ve denetçilerle koordinasyon. Risk register.' },
        { name: '4. Müzakere & Kapanış Desteği', duration: '2-4 hafta', description: 'BATNA hazırlığı, term sheet review, müzakere oturumlarında stratejik danışmanlık.' },
        { name: '5. Post-Merger Integration (PMI)', duration: '3-6 ay', description: '100-günlük plan, organizasyon entegrasyonu, sistem migrasyonu, kültür birleşmesi. Sinerji ölçümü.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Sell-side mı buy-side mı çalışıyorsunuz?', a: 'Her iki tarafta da deneyimimiz var. Conflict-of-interest engagement\'larında dürüstlük için sadece bir tarafı temsil ederiz.' },
        { q: 'Değerleme banker tarafından mı yapılmalı?', a: 'Yatırım bankacılığı işlevi (sürece broker olma) bizim hizmetimiz değil. Stratejik değerleme ve müzakere danışmanlığı veriyoruz; transaction execution için lisanslı banka önerilir.' },
        { q: 'Yabancı alıcı/satıcı ile çalışıyor musunuz?', a: 'Evet. Cross-border M&A\'lerde Türkiye spesifik risk haritası ve cultural fit değerlendirmesi kritik.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Nesiller arası devir süreçleri, kurumsallaşma ve sürdürülebilir aile anayasasının hazırlanması.',
      valueProp: 'Türkiye\'nin ekonomik bel kemiği aile şirketlerinde 3. nesle geçişin en kritik dönemecini birlikte yönetiyoruz: aile değerini koruyarak kurumsallaşma.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Family Discovery', duration: '2-3 hafta', description: 'Tüm aile üyeleriyle bire bir görüşmeler; nesil bazlı değerler ve beklentiler haritalama.' },
        { name: '2. Governance Workshop', duration: '2 hafta', description: 'Aile Konseyi yapısı tasarımı; karar hakları matrisi (operasyon vs aile vs ownership).' },
        { name: '3. Anayasa Drafting', duration: '4-6 hafta', description: 'Yazılı doküman taslakları; aile üyeleri ile iteratif review; hukuki danışmanla validation.' },
        { name: '4. Succession Planning', duration: '3-4 hafta', description: 'Yetki devir takvimi; kuşak transfer mentor programı; profesyonel CEO/CFO interview desteği.' },
        { name: '5. Ratification & Launch', duration: '2 hafta', description: 'Tüm aile üyelerinin imza onayı; ilk Aile Konseyi toplantısı moderasyonu.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Hukuki bağlayıcılığı var mı?', a: 'Aile Anayasası moral pacta sunt servanda niteliğindedir; hukuki bağlayıcılık için hisse devir sözleşmeleri, vekaletname ve şirket ana sözleşmesi revize edilir (hukuki danışmanlık ayrı).' },
        { q: 'Aile içi anlaşmazlık varsa engagement başlatılabilir mi?', a: 'Aktif çatışma varsa önce mediation önerilir. Yapıcı görüşmenin mümkün olduğu noktadan başlarız.' },
        { q: 'Tüm aile üyeleri katılmak zorunda mı?', a: 'Karar haklarını kullananlar (mevcut + yakın gelecek) zorunlu. Tüm aile üyeleri davet edilir; katılım gönüllüdür.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Yalın üretim (Lean), Altı Sigma metodolojileri ve uçtan uca lojistik optimizasyonu.',
      valueProp: 'Maliyet yapısını sahaya inerek söker, OEE/cycle time/lead time gibi metriklerde %15-40 iyileşme yaratır.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Gemba Walk + Value Stream Mapping', duration: '2 hafta', description: 'Sahada bizzat akış izleme; current state value stream haritası; 7 müda (israf) tanımlama.' },
        { name: '2. Baseline + Hedef Belirleme', duration: '1 hafta', description: 'OEE, lead time, FPY ölçümü. Sektörel benchmark. Future state target.' },
        { name: '3. Kaizen Sprint\'leri', duration: '6-8 hafta', description: 'Haftalık 2-3 günlük kaizen workshop\'ları. SMED, 5S, kanban, poka-yoke uygulamaları.' },
        { name: '4. Six Sigma DMAIC Projeler', duration: '8-12 hafta', description: 'Kritik kalite problemleri için statistical process control + DOE. Green Belt eğitim.' },
        { name: '5. Sürdürülebilirlik Sistemleri', duration: '4 hafta', description: 'Daily management board, ekip liderlerine moderasyon eğitimi, KPI dashboard kurulumu.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Lean veya Six Sigma\'ya hangisinden başlamalı?', a: 'Lean (akış + israf) ile Six Sigma (varyans) farklı problemleri çözer. Discovery\'de hangi tip kayıp baskın belirlenir; ekseriya Lean ile başlar, kritik kalite problemleri için Six Sigma\'ya geçilir.' },
        { q: 'Üretim dışı (hizmet, ofis) operasyonlarda da çalışıyor mu?', a: 'Evet. Lean Office, dokümantasyon, hizmet süreçleri için aynı metodoloji uygulanır (different unit of work).' },
        { q: 'İç ekibim eğitilebilir mi?', a: 'Six Sigma Green Belt 3-modül eğitim engagement\'ın parçası. Black Belt sertifikasyonu için ek 6 ay mentor programı opsiyoneldir.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Bilinçdışı tüketici davranışlarını analiz ederek, veri odaklı marka ve iletişim stratejileri.',
      valueProp: 'Tüketici "ne söylediği"nin ötesinde "ne yaptığı" ve "ne hissettiği"ni nörobilimsel framework ile inceler. Marka iletişiminin dönüşüm oranını ölçülebilir biçimde yükseltir.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Stakeholder Discovery + Brand Audit', duration: '2 hafta', description: 'Marka pozisyonu, mevcut iletişim materyalleri, satış-pazarlama uyumu görüşmeleri.' },
        { name: '2. Davranışsal Araştırma Tasarımı', duration: '2 hafta', description: 'Eye-tracking, GSR (galvanic skin response), facial coding, EEG (opsiyonel) protokol tasarımı.' },
        { name: '3. Saha Çalışması & Veri Toplama', duration: '3-4 hafta', description: '60-120 katılımcı ile lab veya in-store araştırma. Davranışsal metrik kaydı.' },
        { name: '4. Analiz & İçgörü Üretimi', duration: '3 hafta', description: 'Quantitative analiz + qualitative tema çıkarımı. Davranışsal persona inşası.' },
        { name: '5. Aktivasyon Workshop', duration: '2 hafta', description: 'Pazarlama ve ürün ekipleriyle bulguların uygulamaya geçirilmesi; A/B test roadmap.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Nöropazarlama "manipülasyon" mu?', a: 'Hayır. Tüketicinin bilinçdışı karar mekanizmalarını anlamak, daha iyi ürün ve iletişim tasarımı için. Etik framework (örn: Neuromarketing Science & Business Association) uygulanır.' },
        { q: 'EEG/fMRI cihaz gerekli mi?', a: 'Engagement seviyesine göre değişir. Çoğu B2B/B2C iş için eye-tracking + facial coding + GSR yeterli. fMRI özel araştırma projelerinde, dış lab ile partner.' },
        { q: 'Sonuçlar küçük örneklemle güvenilir mi?', a: 'Davranışsal araştırmada 60-120 katılımcı istatistiksel anlamlı içgörü üretir (kontrollü protokol + bias mitigation ile).' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Yetenek matrisleri, performans yönetim sistemleri ve çevik organizasyonel yapıların kurgulanması.',
      valueProp: 'İK\'yı "bordro+izin" fonksiyonundan stratejik partnere dönüştürür; org tasarımını stratejiyle uyumlandırır, yetenek yönetimini ölçülebilir hale getirir.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Diagnostic', duration: '2 hafta', description: 'Mevcut org analizi, çalışan engagement araştırması, İK süreç haritası.' },
        { name: '2. Org Design Workshop', duration: '3 hafta', description: 'Yeni org modeli (functional, matrix, agile pod). Karar hakları matrisi.' },
        { name: '3. Performans Sistemi', duration: '4 hafta', description: 'OKR cadence, sürekli feedback ritmi, kalibreli değerlendirme tasarımı.' },
        { name: '4. Yetenek Yönetimi', duration: '4 hafta', description: '9-box değerlendirme, succession planlaması, gelişim havuzu (talent pool).' },
        { name: '5. Change Management', duration: '3 hafta', description: 'Geçiş iletişimi, eğitim, manager enablement, kültürel uyum sprintleri.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    investment: {
      ...
      paymentPlan: '4 milestone: %20 Diagnostic, %30 Org Design, %30 Performance/Talent, %20 Change.',
    },
    trust: {
      anonymizedExample:
    ...
    faq: {
      items: [
        { q: 'Mevcut İK ekibim kalır mı?', a: 'Evet. Engagement, İK ekibi ile birlikte yürütülür; biz "araç + yöntem", onlar "uygulayıcı + sürdürücü". Engagement sonrası İK ekibi otonom işletir.' },
        { q: 'Org küçültme (downsizing) yapar mısınız?', a: 'Strateji gerektiriyorsa evet; ama amacımız genelde "doğru yerde doğru kişi" optimization. Downsizing sadece veri net gösteriyorsa önerilir.' },
        { q: 'Çalışan görüşmeleri gizli mi?', a: 'Evet, 360°/engagement araştırmaları anonim ve toplam raporda agregate edilir. Bireysel görüşmeler güvende kalır.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Finansal veya operasyonel kriz anlarında acil eylem planları ve dayanıklılık (resilience) testleri.',
      valueProp: 'Kriz dönemlerinde 72 saatlik karar penceresinde stratejik triage; iş sürekliliği planı + paydaş iletişimi + finansal manevralar.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Hızlı Triage', duration: '24-48 saat', description: 'Krizin doğası, etkilenen alanlar, hayati riskler. CEO/CFO ile bire bir oturum.' },
        { name: '2. Stabilizasyon Planı', duration: '1 hafta', description: '72-saat planı + 13-hafta nakit + iletişim stratejisi.' },
        { name: '3. Uygulama Komuta', duration: '4-8 hafta', description: 'Günlük standup (kriz komuta odası), karar günlüğü, stakeholder iletişim.' },
        { name: '4. Toparlanma Fazı', duration: '4-12 hafta', description: 'Operasyonel restore, finansal sağlık, müşteri/çalışan güveni yeniden inşası.' },
        { name: '5. Post-Mortem + Resilience', duration: '4 hafta', description: 'Lessons learned, business continuity planı (BCP) güncelleme, simülasyon tatbikatı.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Krize zaten girdik, çok geç mi?', a: 'Hayır. Akut faz desteği 24 saat içinde başlatılabilir. Erken triage karar hızını ve kalitesini dramatik artırır.' },
        { q: 'Hangi tip krizlerle ilgileniyorsunuz?', a: 'Finansal (likidite, banka), operasyonel (üretim duruşu, kalite incident), reputasyonel (medya, sosyal), siber (KVKK ihlali, fidye), regülasyon, doğal afet sonrası BCP.' },
        { q: '7/24 ulaşılabilir misiniz?', a: 'Akut faz aktiveyse evet, kriz komuta odası kurulur. Preventive BCP retainer\'ı ile yıllık tatbikat + on-call destek.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Makine öğrenmesi modelleri ile tahmine dayalı analizler ve yapay zeka entegrasyon stratejileri.',
      valueProp: 'AI hype\'ından ayrılarak ROI odaklı use-case seçimi; pilot → ölçeklendirme yol haritası ve veri-okuryazar organizasyon.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. AI Maturity Audit', duration: '2 hafta', description: 'Mevcut veri varlıkları, AI okuryazarlık seviyesi, organize hazırlık değerlendirmesi.' },
        { name: '2. Use-Case Portfolio', duration: '2 hafta', description: 'İş birimleri ile workshop\'lar; impact × feasibility matrisi; 5-10 use-case listesi.' },
        { name: '3. Data Foundation', duration: '4-6 hafta', description: 'Veri pipeline, kalite kontrol, governance, KVKK uyum.' },
        { name: '4. Pilot ML/GenAI Build', duration: '6-10 hafta', description: '2-3 pilot model (tahmin, classification, GenAI workflow). Production deployment.' },
        { name: '5. Scaling & Capability', duration: '4 hafta', description: 'MLOps platformu, iç ekip eğitim, scaling stratejisi.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'GenAI mi yoksa klasik ML mi öneriyorsunuz?', a: 'Probleme göre değişir. Tahmin/optimization için klasik ML; bilgi yönetimi/içerik üretimi için GenAI. Çoğu engagement\'ta hybrid uygulanır.' },
        { q: 'Hangi cloud platformu?', a: 'AWS, Azure, GCP — müşterinin mevcut cloud stack\'ine göre. Vendor-agnostic mimari prensibimiz.' },
        { q: 'Veri yetersiz olursa?', a: 'AI öncesi data foundation fazı zorunlu. Yetersizse 4-12 hafta hazırlık önerilir; aksi pilot başarısızlık riski yüksek.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'ERP seçimi, süreç otomasyonu (RPA) ve dijital olgunluk analizleri ile teknolojik kaldıraç.',
      valueProp: 'Dijital dönüşüm tool seçimi değil, strateji-süreç-teknoloji-kültür tetragramının uyumlandırılmasıdır. ROI ölçülebilir, kalıcı dönüşüm.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Dijital Olgunluk Audit', duration: '2-3 hafta', description: 'Strateji, süreç, teknoloji, veri, kültür, organizasyon boyutlarında değerlendirme.' },
        { name: '2. Teknoloji Strateji Workshop', duration: '2 hafta', description: 'C-level ile 3-yıllık teknoloji vizyonu; build-buy-partner kararları.' },
        { name: '3. ERP/CRM Seçim Süreci (opsiyonel)', duration: '6-8 hafta', description: 'Vendor değerlendirme, RFP, demo, referans araması, contract review.' },
        { name: '4. RPA / Otomasyon Pilot', duration: '4-6 hafta', description: 'Top 3 use-case için RPA bot tasarım + deploy. ROI ölçümü.' },
        { name: '5. Operating Model Hazırlığı', duration: '3 hafta', description: 'IT operating model design, change management, capability building.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Vendor satıyor musunuz?', a: 'Hayır. Vendor-agnostic\'iz; SAP, Oracle, Microsoft, lokal ERP\'ler — değerlendirme objektif, komisyon almıyoruz.' },
        { q: 'ERP implementation\'ı siz mi yapıyorsunuz?', a: 'Hayır. Vendor partner ekibi implementation\'ı yürütür. Biz seçim, PMO oversight, change management yapıyoruz (independent advisor).' },
        { q: 'RPA hangi platformlarla?', a: 'UiPath, Automation Anywhere, Microsoft Power Automate. Ayrıca Python custom otomasyon.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Veri gizliliği, siber güvenlik yönetişimi ve yasal uyumluluk (ISO 27001) danışmanlığı.',
      valueProp: 'KVKK/GDPR uyumunu compliance-checklist ötesinde stratejik veri yönetişimine çevirir; siber güvenlik kültürünü organize bir disipline dönüştürür.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Mevcut Durum Audit', duration: '3 hafta', description: 'Veri envanteri, mevzuat gap analizi, mevcut güvenlik kontrolleri review.' },
        { name: '2. Risk Değerlendirme', duration: '2 hafta', description: 'Veri kategorileri risk haritası, threat modeling, impact analizi.' },
        { name: '3. Policy & Procedure Yazımı', duration: '4 hafta', description: 'KVKK uyum dokümantasyon paketi (aydınlatma, çerez, açık rıza, veri sahibi başvuru).' },
        { name: '4. Technical Controls', duration: '4-6 hafta', description: 'DLP, access control, log management, incident response playbook.' },
        { name: '5. Eğitim & Sertifikasyon Hazırlık', duration: '3 hafta', description: 'Tüm çalışan KVKK eğitimi, KVK temsilcisi eğitimi, ISO 27001 ön-audit.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'KVK Kurumu denetlerse hazır mıyız?', a: 'Engagement sonunda evet — dokümantasyon + veri envanteri + incident playbook ile denetime hazır pozisyondasınız.' },
        { q: 'ISO 27001 zorunlu mu?', a: 'Hayır; B2B kontrat gereği veya KVKK denetimi öncesi proactive olarak alınır. Sertifikasyon süreci 3-6 ay sürer.' },
        { q: 'Hukuk firması ile koordinasyon yapıyor musunuz?', a: 'Evet, mevcut hukuk firmanızla birlikte çalışırız. Hukuki yorum gerektiren dokümanlar avukat onayından geçer.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Karbon ayak izi raporlaması, sürdürülebilirlik stratejileri ve yeşil finansman erişimi.',
      valueProp: 'AB Yeşil Mutabakatı + CBAM sınırında Türk üreticisi için stratejik ESG yol haritası: maliyet değil, rekabet avantajı olarak.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Materiality Assessment', duration: '3 hafta', description: 'Hangi ESG konuları sektör + paydaş için kritik; öncelik haritası.' },
        { name: '2. Karbon Envanteri', duration: '4-6 hafta', description: 'Scope 1, 2, 3 emisyon hesaplama; ISO 14064 / GHG Protocol uyumlu.' },
        { name: '3. ESG Strateji Workshop', duration: '2 hafta', description: 'C-level ile 5-10 yıllık ESG hedefler, decarbonization yol haritası.' },
        { name: '4. Reporting Framework', duration: '4 hafta', description: 'GRI / SASB / TCFD seçimi; ilk sürdürülebilirlik raporu draft.' },
        { name: '5. Aktivasyon + Yeşil Finansman', duration: '3 hafta', description: 'İç ESG governance, yeşil bond/loan vendor görüşmeler, KPI dashboard.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'CBAM bizi nasıl etkiler?', a: 'AB\'ye ihracatınız varsa karbon-yoğun ürünlerde (demir-çelik, çimento, alüminyum, gübre, hidrojen, elektrik) 2026 itibariyle ek vergi. Etki simülasyonu engagement ilk fazında yapılır.' },
        { q: 'Hangi reporting framework seçmeli?', a: 'GRI çoğu sektör, SASB sermaye piyasası odaklı, TCFD iklim spesifik. Engagement\'ta sektör + paydaş beklentisine göre seçim yapılır.' },
        { q: 'Karbon nötr olmak gerekli mi?', a: 'Gerekli değil ama AB pazarı + yatırımcı + müşteri baskısı artıyor. Net-zero hedefi engagement\'da değerlendirilir.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Devlet destekleri, Ar-Ge hibeleri ve proje bazlı yatırım teşvik belgesi süreçleri.',
      valueProp: 'Türkiye\'nin teşvik mevzuatında 200+ destek programı içinden şirketinize uygun olanları haritalayıp başvuru-değerlendirme-uygulama süreçlerini yönetir.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Eligibility Audit', duration: '2 hafta', description: 'Şirket finansal+operasyonel profil, mevcut teşvik durumu, uygun programlar haritalama.' },
        { name: '2. Strateji Workshop', duration: '1 hafta', description: 'Hangi başvurulara öncelik; kaynak ayırma; takvim.' },
        { name: '3. Başvuru Dosyalarının Hazırlanması', duration: '4-8 hafta', description: 'TÜBİTAK / KOSGEB / Sanayi / AB başvuru taslakları + ekler.' },
        { name: '4. Değerlendirme Sürecinde Destek', duration: '8-12 hafta', description: 'Mülakat hazırlık, ek belge yanıtları, savunma.' },
        { name: '5. Tamamlama Vizesi + Raporlama', duration: 'Yıllık (uzun vadeli)', description: 'Yatırım gerçekleşmesi sonrası vizyon, yıllık denetim raporları.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Başvuru reddedilirse?', a: 'Başvuru süreçlerinde başarı olasılığı maksimize için kalite gate\'leri kullanırız. Red durumunda revize başvuru veya alternatif program değerlendirilir; success fee sadece kabul edilen başvurulardan.' },
        { q: 'Hangi sektörlerde çalışıyorsunuz?', a: 'Türkiye teşvik mevzuatı çoğu sektörü kapsar; üretim, teknoloji, tarım, hizmet, enerji. Sektörel uzmanlık başvuru kalitesini artırır.' },
        { q: 'AB hibelerine başvuru için partner bulabilir misiniz?', a: 'AB Horizon Europe consortium kurulumunda Avrupa partner havuzumuz var; partner matchmaking destek veriyoruz.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Kur, faiz ve enflasyon projeksiyonları ile C-Level stratejik karar destek raporları.',
      valueProp: 'Türkiye + global makro değişkenler için scenario planning. CFO/CEO\'nun "ne olursa ne yapacağız" sorusuna yapılandırılmış cevap.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Risk Exposure Audit', duration: '2 hafta', description: 'P&L + Balance Sheet üzerinde makro değişken duyarlılığı; FX/faiz/komodite exposure haritası.' },
        { name: '2. Scenario Workshop', duration: '2 hafta', description: 'CFO ile 4 senaryo: base, bull, bear, shock. Olasılık atama.' },
        { name: '3. Hedge & Pricing Strategy', duration: '3 hafta', description: 'Hedge enstrüman seçimi (banka quote review), pricing formülü.' },
        { name: '4. Forecast Model Build', duration: '3 hafta', description: '13-hafta + 24-ay finansal model (Excel/Power BI). Sensitivite analizi.' },
        { name: '5. Aylık Briefing Sistemi', duration: 'Devam eden', description: 'Aylık makro raporu, scenario revize, action triggers.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Banka treasury ekibim varsa yine ihtiyacım var mı?', a: 'Treasury enstrüman execution\'da uzman; biz strateji + scenario + organizasyon ortak çalışıyoruz. Tamamlayıcı rolde.' },
        { q: 'Tek banka mı çoklu banka mı?', a: 'Counterparty risk için 3-5 banka önerilir. Hedge instrument quote\'larını karşılaştırma engagement parçası.' },
        { q: 'Yatırım kararı veriyor musunuz?', a: 'Hayır, regulated investment advice vermiyoruz. Stratejik karar destek + sceanrio analiz veriyoruz.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Antitröst incelemeleri, pazar hakimiyeti analizleri ve regülasyon uyum danışmanlığı.',
      valueProp: 'Rekabet Kurumu / EU Commission soruşturmalarında ekonomik analiz; M&A bildirim öncesi antitröst risk değerlendirmesi.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Case Discovery', duration: '1 hafta', description: 'Soruşturma / işlem detayları, mevcut hukuki danışmanla koordinasyon.' },
        { name: '2. Market Definition', duration: '2 hafta', description: 'SSNIP test, ürün + coğrafi pazar tanımlama, ekonomik veri toplama.' },
        { name: '3. Concentration / Effects Analysis', duration: '2-3 hafta', description: 'HHI hesabı, dominance kriterleri, fiyat/innovation etki analizi.' },
        { name: '4. Ekonomik Savunma Notu', duration: '2 hafta', description: 'Rekabet Kurumu / Komisyon\'a sunulacak ekonomik argümanların yazımı.' },
        { name: '5. Hearing Support', duration: 'Devam eden', description: 'Sözlü savunma hazırlık, soru-cevap, expert witness desteği.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    investment: {
      ...
      paymentPlan: 'Faz-bazlı: %25 discovery + market def, %35 effects, %25 savunma notu, %15 hearing.',
    },
    trust: {
      anonymizedExample:
    ...
    faq: {
      items: [
        { q: 'Hukuk firması yerine sizinle mi çalışmalıyım?', a: 'Hayır, birlikte. Rekabet hukuku avukatları hukuki yorum + savunmayı yapar; biz ekonomik analiz + quantitative argüman üretiriz. Tamamlayıcı.' },
        { q: 'Hangi yargı yetki alanı?', a: 'Türkiye (Rekabet Kurumu), AB (Komisyon + ulusal otoriteler), UK (CMA), US (FTC/DOJ — bağımsız ABD ekonomist partner).' },
        { q: 'Expert witness olarak duruşmada çıkıyor musunuz?', a: 'Senior ekibimiz ekonomist expert witness rolünde duruşmaya katılabilir; case bazlı değerlendirilir.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Toplu iş sözleşmesi müzakereleri, sendikal ilişkiler yönetimi ve çalışma barışının korunması.',
      valueProp: 'Toplu sözleşme dönemlerinde sendika ile yapılandırılmış müzakere; çalışma barışını korurken işveren maliyet zarfı içinde tutar.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Diagnostic', duration: '2 hafta', description: 'Önceki TİS\'ler review, mali kapasite analizi, sendika talep haritası.' },
        { name: '2. Müzakere Strateji', duration: '2 hafta', description: 'BATNA, walk-away, sıra (sequence) planlama, takım rolleri.' },
        { name: '3. Pre-müzakere Hazırlık', duration: '2 hafta', description: 'Senaryo tatbikatı, soru-cevap, ekonomik veri paketi.' },
        { name: '4. Müzakere Oturumları Desteği', duration: '4-12 hafta', description: 'Oturum öncesi briefing, oturum gözlem, taktik revize.' },
        { name: '5. Post-Anlaşma Implementation', duration: '4 hafta', description: 'Sözleşme uygulamasının operasyona yansıması; çalışma barışı KPI sistemi.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Sendika ile direkt görüşüyor musunuz?', a: 'Hayır, işveren tarafının danışmanıyız. Müzakere oturumunda işveren temsilcileri masada; biz arka odada strateji destek.' },
        { q: 'Hukuk firması ile birlikte mi?', a: 'Evet, hukuki konularda iş hukuku avukatınız primary; biz ekonomik analiz + müzakere taktik destek.' },
        { q: 'Çalışan tarafına da çalışıyor musunuz?', a: 'Hayır, conflict-of-interest. Sadece işveren tarafında.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'SGK prim teşviklerinden maksimum yararlanma, maliyet optimizasyonu ve bordro risk denetimi.',
      valueProp: 'Bordro maliyetinin %5-15\'ini geri kazandırır; SGK / İş-Kur teşvik uygulamalarındaki boşlukları sistematik kapatır.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Bordro Veri Toplama', duration: '2 hafta', description: 'Son 24 ayın bordro çıktıları, SGK bildirgeleri, sözleşmeler.' },
        { name: '2. Teşvik Audit', duration: '3 hafta', description: 'Her teşvik kanunu için uygulanma durumu kontrol; eksik/yanlış başvurular.' },
        { name: '3. Bordro Hesaplama Audit', duration: '2 hafta', description: 'Kıdem, ihbar, fazla mesai, izin hesaplamalarında metodoloji uygunluğu.' },
        { name: '4. Telafi Başvuruları', duration: '2-4 hafta', description: 'Geriye dönük teşvik düzeltme başvuruları, SGK iletişimi.' },
        { name: '5. Süreç İyileştirme', duration: '2 hafta', description: 'Aylık teşvik checkup, bordro otomasyon önerileri, eğitim.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'SMMM / mali müşavir varsa yine ihtiyacım var mı?', a: 'SMMM bordro execution yapar; biz audit + teşvik optimization layer\'ı. Genelde 2-3 yılda bir audit faydalı (mevzuat değişimi sıklığı).' },
        { q: 'Geriye dönük kaç yıl?', a: 'SGK 5 yıl, vergi 5 yıl zamanaşımı. Pratikte son 2-3 yıl audit yeterli.' },
        { q: 'Süreç sonrası destek var mı?', a: 'Aylık teşvik checkup retainer (₺8-15k/ay) opsiyoneldir; mevzuat değişiminde otomatik notify.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Nitelikli işgücünü çekmek ve elde tutmak için stratejik işveren markası (Employer Branding) tasarımı.',
      valueProp: 'İşveren değer önerisini (EVP) data + insight ile inşa eder; recruitment cost ve turnover\'ı düşürürken çalışan engagement\'ı artırır.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Audit & Diagnostic', duration: '3 hafta', description: 'Mevcut algı (çalışan + aday survey), Glassdoor/LinkedIn review, rakip benchmark.' },
        { name: '2. EVP Workshop', duration: '2 hafta', description: 'Üst yönetim + İK + pazarlama workshop; "neden bizde çalışmalı" çekirdek hikaye.' },
        { name: '3. Brand Codifying', duration: '3 hafta', description: 'EVP key messaging, görsel kimlik, rol bazlı pazarlama paketleri.' },
        { name: '4. Recruitment Marketing Launch', duration: '4 hafta', description: 'LinkedIn / Glassdoor / company website kampanya kurulumu, content takvimi.' },
        { name: '5. Onboarding Redesign', duration: '3 hafta', description: '90-günlük journey, milestone\'lar, manager enablement, çalışan refer programı.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'EVP "marka pazarlaması" mı?', a: 'Daha geniş. EVP, çalışan deneyimi gerçeğini de değiştirir (kültür, kariyer, ödül). Pazarlama dış katmanı; engagement içeride başlar.' },
        { q: 'Glassdoor review\'ları yönetebilir miyiz?', a: 'Manipülasyon yasak. Doğru taktik: sahte değil, gerçek çalışan deneyimini iyileştirmek, mevcut çalışanları organik referans için aktive etmek.' },
        { q: 'Recruitment agency ile çakışıyor mu?', a: 'Hayır. Agency execution yapar; biz strateji + brand katmanı kurarız. Agency\'nin kullandığı materyal kaliteli olur.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      valueProp: 'İhracatçı şirket için 2-3 hedef pazarda go-to-market stratejisi: distribütör havuzu + Turquality başvurusu + ihracat finansman.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Strategic Diagnostic', duration: '2 hafta', description: 'Ürün + sektör fit, ihracat kapasitesi, organizasyonel hazırlık.' },
        { name: '2. Pazar Tarama', duration: '4 hafta', description: '10-15 hedef pazar fizibilite; küçültme 3 finaliste.' },
        { name: '3. Deep Dive 3 Pazar', duration: '4-6 hafta', description: 'Distribütör havuzu, regülasyon, rekabet, fiyatlandırma, tedarik chain.' },
        { name: '4. Go-to-Market Plan', duration: '3 hafta', description: 'Lansman planı, sales channel, brand adaptation, finansal model.' },
        { name: '5. Distribütör Match + Turquality', duration: '4-8 hafta', description: 'Distribütör görüşmeleri + LOI desteği; Turquality başvuru hazırlık.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Hangi pazarlara odaklanıyorsunuz?', a: 'AB ülkeleri, ME (Mısır, Suudi, BAE), Afrika (Mısır, Fas, Nijerya), Orta Asya (Özbekistan, Kazakistan), Balkanlar.' },
        { q: 'Distribütör buluyor musunuz yoksa sadece danışmanlık?', a: 'Aktif olarak Distribütör havuzunu tarar, görüşmeleri organize ederiz. Final seçim ve sözleşme müşteriye ait.' },
        { q: 'Turquality başvurusunu yapıyor musunuz?', a: 'Başvuru dosyasını hazırlıyoruz. Onay süreci Ticaret Bakanlığı\'na ait. Engagement sonu success fee opsiyonel.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      valueProp: 'Sınır-aşırı iş yapan şirketler için aylık geopolitik briefing + risk-event simülasyonu; Rusya-Ukrayna, ABD-Çin, AB-Türkiye gibi gerilim eksenlerinde stratejik karar destek.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Strategic Exposure Audit', duration: '3 hafta', description: 'Ülke / koridor / partner exposure haritalama; sanctions risk evaluasyonu.' },
        { name: '2. Sanctions Compliance', duration: '3 hafta', description: 'US OFAC, EU, UK sanctions screening, müşteri/tedarikçi due diligence süreç tasarımı.' },
        { name: '3. Tedarik Zinciri Diversification', duration: '4 hafta', description: 'Tek-noktada konsantrasyonun değerlendirilmesi; alternative coğrafya/partner analizi.' },
        { name: '4. Çeyreklik Briefing Sistemi', duration: 'Devam eden', description: 'Quarterly geopolitik briefing, sektör + ülke spesifik.' },
        { name: '5. Kriz Simülasyonu', duration: '2 hafta', description: 'Tabletop exercise: Rusya-Ukrayna, ABD-Çin, AB-Türkiye senaryolarında karar tatbikatı.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Hangi ülkeler / bölgeler kapsamda?', a: 'Türkiye odaklı: AB, ME, Rusya-CIS, Orta Asya, Afrika kuzey-batı, ABD compliance perspektifinden. Asya-Pasifik isteğe bağlı.' },
        { q: 'Sanctions ihlali oluştuysa ne yaparsınız?', a: 'Önce kontrol: gerçekten ihlal mi yoksa risk algılaması mı. Gerçek ihlal hukuki tavsiye + yetkili otoritelere remediation. Biz strateji, hukuki yorum avukatla.' },
        { q: 'Devlet ihalelerinde danışmanlık veriyor musunuz?', a: 'Stratejik konteksti analiz ederiz (rekabet, diplomatik faktör). Lobby + temsil için /services/government-relations.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      subtitle: 'Yerel yönetimler için dijital şehircilik stratejileri ve etki analizi raporlaması.',
      valueProp: 'Belediye ve büyükşehir yönetimlerinde dijital dönüşüm yol haritası: vatandaş hizmetleri, ulaşım, enerji, atık, güvenlik için akıllı şehir mimarisi.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Maturity Assessment', duration: '3 hafta', description: 'Mevcut dijital varlıklar, ekosistem analizi, vatandaş beklentisi araştırması.' },
        { name: '2. Strategy Workshop', duration: '2 hafta', description: 'Yönetim + müdürlüklerle workshop\'lar; vizyon + öncelik haritası.' },
        { name: '3. Roadmap & Architecture', duration: '4 hafta', description: 'Teknoloji mimarisi, vendor strateji, faz-bazlı yatırım planı.' },
        { name: '4. Pilot Tasarımı', duration: '3 hafta', description: '1-2 pilot project (örn: smart waste, citizen portal) için detay tasarım.' },
        { name: '5. Hibe Başvuruları', duration: '4 hafta', description: 'AB Horizon, TÜBİTAK, Sanayi Bakanlığı başvuru paketleri.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Hangi belediye ölçeği için uygun?', a: 'İl + büyükşehir + 100k+ nüfuslu ilçe belediyeleri için ideal. Küçük belediyeler için adapted scope.' },
        { q: 'Vendor seçiyor musunuz?', a: 'Vendor-agnostic; mimari ve seçim metodolojisi sağlıyoruz, implementation belediye prosedürü ile ihale ediliyor.' },
        { q: 'Kamu ihale prosedürleriyle uyumlu mu?', a: 'Evet, KİK + Sayıştay denetimi gözeten dokümantasyon sağlanır.' },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    hero: {
      ...
      valueProp: 'Sektörünüzü etkileyen mevzuat değişikliklerinde erken sinyal + Ankara/Brüksel\'de paydaş haritalama + etik lobicilik desteği.',
    ...
    methodology: {
      ...
      phases: [
        { name: '1. Diagnostic + Stakeholder Mapping', duration: '3 hafta', description: 'Bakanlık + meclis + parti + dernek paydaş haritası; mevcut ilişki seviyesi.' },
        { name: '2. Regulatory Radar Kurulumu', duration: '2 hafta', description: 'TBMM + bakanlık + AB Komisyon mevzuat takip sistem tasarımı.' },
        { name: '3. Position Paper Strateji', duration: '3 hafta', description: 'Sektör için 3-5 kritik konuda pozisyon kağıdı, mesajlama, sahiplenme.' },
        { name: '4. İlişki İnşası & Briefing', duration: '4-6 hafta', description: 'Stratejik görüşme planlaması, brief preparation, randevu desteği.' },
        { name: '5. Aylık GR Briefing Sistemi', duration: 'Devam eden', description: 'Aylık mevzuat radar + briefing notu + strateji revize.' },
      ],
    },
    deliverables: {
      title: 'Teslim Edilen Çıktılar',
    ...
    faq: {
      items: [
        { q: 'Lobicilik yasal mı?', a: 'Türkiye\'de lobicilik regülasyonu net değil; etik framework (transparency, no quid pro quo, kayıt) uygulanır. AB\'de lobicilik kayıtlı + regulated. Tüm engagement\'larda etik çerçeve kritik.' },
        { q: 'Doğrudan bakana / milletvekiline ulaşıyor musunuz?', a: 'Stratejik görüşme planlaması yaparız; ulaşım çoğu zaman dernek + üst düzey CEO eli ile. Eşliği destekleriz, vekaleten konuşmayız.' },
        { q: 'Hangi sektörlerde deneyim var?', a: 'İlaç, gıda, enerji, finans, teknoloji, ulaşım, çevre. Sektör spesifik mevzuat radar farklı kurgulu.' },
