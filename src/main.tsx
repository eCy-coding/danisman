...
// PostHog + GTM: both are consent-gated. PostHog inits in opt-out state
// (no events ship until analytics consent); GTM script does not load
// until marketing consent is granted via CookieBanner.
initPostHog();
initGtm();
