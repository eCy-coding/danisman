    ...
    return (
        <React.Fragment>
            <Helmet>
                ...
                <meta name="description" content="EcyPro ile hemen iletişime geçin. Stratejik büyüme hedefleriniz için profesyonel destek alın." />
                <link rel="canonical" href="https://ecypro.com/contact" />
            </Helmet>
            <JsonLd data={buildBreadcrumbSchema([
                { name: lang.startsWith('tr') ? 'Anasayfa' : 'Home', url: 'https://ecypro.com/' },
                { name: lang.startsWith('tr') ? 'İletişim' : 'Contact', url: 'https://ecypro.com/contact' },
            ])} />
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="space-y-12">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white leading-tight">
                                    ...
                                    <span className="text-secondary">{t('contact.subtitle') || 'Hayata Geçirelim'}</span>
                                </h1>
                                <p className="text-lg text-slate-400 font-light leading-relaxed">
                                    {t('contact.intro') || 'Bizimle iletişime geçerek işinizi bir sonraki seviyeye taşıyacak stratejileri belirleyin.'}
                                </p>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4 p-6 glass-card rounded-xl transition-all hover:border-white/20">
                                    ...
                                    <div>
                                        ...
                                        <a href={`mailto:${CONTACT_CONFIG.email}`} className="text-lg text-slate-300 hover:text-secondary transition-colors">
                                ...
                                <div className="flex items-start gap-4 p-6 glass-card rounded-xl transition-all hover:border-white/20">
                                    ...
                                    <div>
                                        ...
                                        <a href={`tel:${CONTACT_CONFIG.phone}`} className="text-lg text-slate-300 hover:text-secondary transition-colors">
                        ...
                        <div className="glass-card p-8 md:p-12 rounded-3xl sticky top-32">
                            ...
                            <h2 className="text-2xl font-bold mb-8 text-white">{t('contact.form_title') || 'Mesaj Gönderin'}</h2>
                            <ContactForm />
                        </div>
                    </div>
                </div>
