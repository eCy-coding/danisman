      ...
      <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="hidden lg:flex flex-col justify-between bg-[#050810] text-white p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
                <div className="w-10 h-10 rounded-xl bg-linear-to-br from-primary to-primary-dark flex items-center justify-center font-bold font-serif text-xl border border-white/10 mb-8">E</div>
                <h2 className="text-5xl font-serif font-medium leading-tight mb-6">
                   Join the <span className="text-secondary">Elite</span><br/>Network.
                </h2>
        ...
        <div className="flex items-center justify-center bg-neutral p-6 md:p-12">
            <div className="w-full max-w-md space-y-8">
                <div className="text-center lg:text-left">
                    <h1 className="text-3xl font-bold text-white">{t('auth.create_account') || 'Create Account'}</h1>
                    <p className="text-slate-400 mt-2">{t('auth.enter_details') || 'Enter your details to get started.'}</p>
                </div>

                <form data-testid="register-form" className="space-y-6">
                    <div className="space-y-2">
                        <label htmlFor={nameId} className="text-sm font-medium text-slate-300">Full Name</label>
                        <input
                            id={nameId}
                            type="text"
                            autoComplete="name"
                    ...
                    <div className="space-y-2">
                        <label htmlFor={emailId} className="text-sm font-medium text-slate-300">Email Address</label>
                        <input
                            id={emailId}
                            type="email"
                            autoComplete="email"
                    ...
                    <div className="space-y-2">
                        <label htmlFor={passwordId} className="text-sm font-medium text-slate-300">Password</label>
                        <div className="relative">
                            ...
                            />
                            <Lock size={16} className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400" aria-hidden="true" />
                        </div>
                    </div>
