  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <button
          type="button"
          className="flex items-center gap-2 bg-secondary text-black font-bold px-4 py-2.5 rounded-lg hover:bg-secondary/90 transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(204,164,59,0.2)]"
        >
          <Plus size={18} />
